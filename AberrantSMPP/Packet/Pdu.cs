...
namespace Aberrant.SMPP.Core.Packet
{
    /// <summary>
    ...
    public abstract class Pdu : IDisposable
    {
        ...
        /// </summary>
        public CommandStatus CommandStatus { get; set; } = 0;

        /// <summary>
        /// The command ID of this Pdu.
        /// </summary>
        protected CommandId CommandID { get; set; }
        ...
        public byte[] PacketBytes
        {
            ...
            private set => _PacketBytes = value;
        }
        ...
        protected Pdu(byte[] incomingBytes)
        {
            ...
            CommandLength = DecodeCommandLength(_PacketBytes);
            CommandID = DecodeCommandId(_PacketBytes);
            CommandStatus = (CommandStatus) UnsignedNumConverter.SwapByteOrdering(BitConverter.ToUInt32(_PacketBytes, 8));
            SequenceNumber = UnsignedNumConverter.SwapByteOrdering(BitConverter.ToUInt32(_PacketBytes, 12));
        ...
        protected ArrayList GetPduHeader()
        {
            ...
            pdu.AddRange(BitConverter.GetBytes(UnsignedNumConverter.SwapByteOrdering((uint) CommandID)));
            pdu.AddRange(BitConverter.GetBytes(UnsignedNumConverter.SwapByteOrdering((uint) CommandStatus)));
            pdu.AddRange(BitConverter.GetBytes(UnsignedNumConverter.SwapByteOrdering(SequenceNumber)));
            pdu.TrimToSize();
            return pdu;
        }
        ...
        public string GetOptionalParamString(OptionalParamCodes tag)
        {
            ...
            if (!ContainsOptionalParameter(tag))
                return null;
        ...
        public byte[] GetOptionalParamBytes(OptionalParamCodes tag)
        {
            ...
            return ContainsOptionalParameter(tag) ? _tlvTable.GetBytes(UnsignedNumConverter.SwapByteOrdering((ushort) tag)) : null;
        }
        ...
        protected UInt16? GetHostOrderUInt16FromTlv(OptionalParamCodes tag)
        {
            ...
            return data == null ? new Nullable<UInt16>() : UnsignedNumConverter.SwapByteOrdering(BitConverter.ToUInt16(data, 0));
        }
        ...
        protected UInt32? GetHostOrderUInt32FromTlv(OptionalParamCodes tag)
        {
            ...
            return data == null ? new Nullable<UInt32>() : UnsignedNumConverter.SwapByteOrdering(BitConverter.ToUInt32(data, 0));
        }
