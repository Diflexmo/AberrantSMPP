...
namespace Aberrant.SMPP.Core.Packet.Response
{
    ...
    public class SmppBindResp : SmppResponse
    {
        ...
        protected override CommandId DefaultCommandId => CommandId.bind_transceiver_resp;
        ...
        public string SystemId
        {
            ...
            set => _SystemId = (value == null) ? string.Empty : value;
        }
        ...
        {
            get => GetOptionalParamByte(OptionalParamCodes.SC_interface_version);

            set => SetOptionalParamByte(OptionalParamCodes.SC_interface_version, value);
        }
