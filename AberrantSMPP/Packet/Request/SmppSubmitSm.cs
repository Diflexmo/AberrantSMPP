...
namespace Aberrant.SMPP.Core.Packet.Request
{
    ...
    public class SmppSubmitSm : SmppSubmit
    {
        ...
        protected override CommandId DefaultCommandId => CommandId.submit_sm;

        /// <summary>
        /// Type of Number for destination.
        /// </summary>
        public TonType DestinationAddressTon { get; set; }

        /// <summary>
        /// Numbering Plan Indicator for destination.
        /// </summary>
        public NpiType DestinationAddressNpi { get; set; }
        ...
        {
            get => GetOptionalParamByte<bool>(OptionalParamCodes.more_messages_to_send);

            set => SetOptionalParamByte(OptionalParamCodes.more_messages_to_send, value);
        }
        ...
        {
            get => GetOptionalParamByte(OptionalParamCodes.ussd_service_op);

            set => SetOptionalParamByte(OptionalParamCodes.ussd_service_op, value);
        }
