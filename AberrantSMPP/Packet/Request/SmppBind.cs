...
namespace Aberrant.SMPP.Core.Packet.Request
{
    ...
    public class SmppBind : SmppRequest
    {
        ...
        protected override CommandId DefaultCommandId => CommandId.bind_transmitter;
        ...
        /// </summary>
        public SmppVersionType InterfaceVersion { get; set; } = SmppVersionType.Version3_4;

        /// <summary>
        /// Indicates type of number of ESME address.
        /// </summary>
        public TonType AddressTon { get; set; } = TonType.International;

        /// <summary>
        /// Numbering plan indicator for ESME address.
        /// </summary>
        public NpiType AddressNpi { get; set; } = NpiType.ISDN;
