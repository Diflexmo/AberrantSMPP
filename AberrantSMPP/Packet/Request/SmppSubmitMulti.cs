...
namespace Aberrant.SMPP.Core.Packet.Request
{
    ...
    public class SmppSubmitMulti : SmppSubmit
    {
        ...
        protected override CommandId DefaultCommandId => CommandId.submit_multi;

        /// <summary>
        /// The number of destinations to send to.
        /// </summary>
        public byte NumberOfDestinations { get; private set; } = 0;
        ...
        {
            get => (DestinationAddress[]) _DestinationAddresses.Clone();
            set
            {
                _DestinationAddresses = (value == null) ? new DestinationAddress[0] : value;
                NumberOfDestinations = (byte) _DestinationAddresses.Length;
            }
        }
        ...
        protected override void DecodeSmscResponse()
        {
            ...
            {
                NumberOfDestinations = remainder[0];
