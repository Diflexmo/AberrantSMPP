...
namespace Aberrant.SMPP.Core.Packet.Request
{
    ...
    public class SmppDataSm : SmppRequest3
    {
        ...
        protected override CommandId DefaultCommandId => CommandId.data_sm;
        ...
        {
            get => GetOptionalParamByte<NetworkType>(OptionalParamCodes.source_network_type);

            set => SetOptionalParamByte(OptionalParamCodes.source_network_type, value);
        }
        ...
        {
            get => GetOptionalParamByte<BearerType>(OptionalParamCodes.source_bearer_type);

            set => SetOptionalParamByte(OptionalParamCodes.source_bearer_type, value);
        }
        ...
        {
            get => GetHostOrderUInt16FromTlv(OptionalParamCodes.source_telematics_id);

            set => SetHostOrderValueIntoTlv(OptionalParamCodes.source_telematics_id, value);
        }
        ...
        {
            get => GetOptionalParamByte<NetworkType>(OptionalParamCodes.dest_network_type);

            set => SetOptionalParamByte(OptionalParamCodes.dest_network_type, value);
        }
        ...
        {
            get => GetOptionalParamByte<BearerType>(OptionalParamCodes.dest_bearer_type);

            set => SetOptionalParamByte(OptionalParamCodes.dest_bearer_type, value);
        }
        ...
        {
            get => GetHostOrderUInt16FromTlv(OptionalParamCodes.dest_telematics_id);

            set => SetHostOrderValueIntoTlv(OptionalParamCodes.dest_telematics_id, value);
        }
        ...
        {
            get => GetHostOrderUInt32FromTlv(OptionalParamCodes.qos_time_to_live);

            set => SetHostOrderValueIntoTlv(OptionalParamCodes.qos_time_to_live, value);
        }
        ...
        {
            get => GetOptionalParamByte(OptionalParamCodes.number_of_messages);
        ...
        {
            get => GetOptionalParamByte<ItsReplyTypeType>(OptionalParamCodes.its_reply_type);

            set => SetOptionalParamByte(OptionalParamCodes.its_reply_type, value);
        }
