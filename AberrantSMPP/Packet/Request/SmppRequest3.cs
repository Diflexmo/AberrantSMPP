...
namespace Aberrant.SMPP.Core.Packet.Request
{
    ...
    public abstract class SmppRequest3 : SmppRequest2
    {
        ...
        {
            get => GetOptionalParamByte<AddressSubunitType>(OptionalParamCodes.source_addr_subunit);
            set => SetOptionalParamByte(OptionalParamCodes.source_addr_subunit, value);
        }
        ...
        {
            get => GetOptionalParamByte(OptionalParamCodes.ms_msg_wait_facilities);

            set => SetOptionalParamByte(OptionalParamCodes.ms_msg_wait_facilities, value);
        }
        ...
        {
            get => GetOptionalParamByte<MsValidityType>(OptionalParamCodes.ms_validity);

            set => SetOptionalParamByte(OptionalParamCodes.ms_validity, value);
        }
        ...
        {
            get => GetHostOrderUInt16FromTlv(OptionalParamCodes.sms_signal);

            set => SetHostOrderValueIntoTlv(OptionalParamCodes.sms_signal, value);
        }
        ...
        {
            get => GetOptionalParamByte<AddressSubunitType>(OptionalParamCodes.dest_addr_subunit);

            set => SetOptionalParamByte(OptionalParamCodes.dest_addr_subunit, value);
        }
        ...
        {
            get => GetOptionalParamByte<DisplayTimeType>(OptionalParamCodes.display_time);

            set => SetOptionalParamByte(OptionalParamCodes.display_time, value);
        }
        ...
        {
            get => GetOptionalParamByte(OptionalParamCodes.callback_num_pres_ind);

            set => SetOptionalParamByte(OptionalParamCodes.callback_num_pres_ind, value);
        }
        ...
        {
            get => GetOptionalParamBytes(OptionalParamCodes.callback_num_atag);
